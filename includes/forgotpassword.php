...
if(isset($_POST['update']))
{
  ...
  {
    echo "<script>alert('L'identifiant e-mail ou le numéro de mobile est incorrect');</script>"; 
  }
}
?>
          ...
          <div class="forgotpassword_wrap">
            <div class="col-md-12">
              <form name="chngpwd" method="post" onSubmit="return valid();">
                ...
                <div class="form-group">
                  <input type="text" name="mobile" class="form-control" placeholder="Votre numéro de mobile*" required="">
                </div>
                <div class="form-group">
