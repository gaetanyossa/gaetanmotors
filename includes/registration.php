...
function valid()
{
  ...
  {
    alert("Les champs de mot de passe et de confirmation du mot de passe ne correspondent pas !!");
          ...
          <div class="signup_wrap">
            <div class="col-md-12 col-sm-6">
              <form  method="post" name="signup" onSubmit="return valid();">
                ...
                <div class="form-group">
                  <input type="text" class="form-control" name="mobileno" placeholder="Numéro de mobile" maxlength="10" required="required">
                </div>
                <div class="form-group">
                ...
                <div class="form-group checkbox">
                  ...
                  <label for="terms_agree">J'accepte les <a href="#">Conditions d'utilisation</a></label>
                </div>
                <div class="form-group">
