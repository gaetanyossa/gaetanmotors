...
<title>Portail de Location de motos | Liste de motos</title>
<!-- Bootstrap -->
<link rel="stylesheet" href="assets/css/bootstrap.min.css" type="text/css">
<!-- Style personnalisé -->
<link rel="stylesheet" href="assets/css/styles.css" type="text/css">
<!-- Curseur OWL Carousel -->
<link rel="stylesheet" href="assets/css/owl.carousel.css" type="text/css">
<link rel="stylesheet" href="assets/css/owl.transitions.css" type="text/css">
<!-- Curseur slick-slider -->
<link href="assets/css/slick.css" rel="stylesheet">
<!-- Curseur bootstrap-slider -->
...
<!-- Démarrer le sélecteur de couleur -->
  ...
  <div class="container">
    <div class="page-header_wrap">
      <div class="page-heading">
        <h1>Liste de Vélos</h1>
      </div>
      <ul class="coustom-breadcrumb">
        <li><a href="#">Accueil</a></li>
        <li>Liste de motos</li>
      </ul>
    </div>
  </div>
...
<?php
// Requête pour compter les annonces
$brand=$_POST['brand'];
...
{  ?>
      ...
      <aside class="col-md-3 col-md-pull-9">
		...
		<?php }} ?>
							...
							<div class="form-group select">
								<select class="form-control" name="fueltype">
									<option>Sélectionnez le Type de Carburant</option>
        ...
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-car" aria-hidden="true"></i> moto Récemment Répertoriés</h5>
          </div>
